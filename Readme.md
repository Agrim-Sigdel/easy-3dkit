...
[**Live gallery**](https://3d-kit.netlify.app/gallery) ·
...
copy-paste snippet in the [docs](https://3d-kit.netlify.app/).
...
- [Docs site](https://3d-kit.netlify.app/) — a live, editable page
